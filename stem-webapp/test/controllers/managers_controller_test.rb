...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { Address: @manager.Address, Cellphone: @manager.Cellphone, City: @manager.City, Code: @manager.Code, Name: @manager.Name, user_id: @manager.user_id } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { Address: @manager.Address, Cellphone: @manager.Cellphone, City: @manager.City, Code: @manager.Code, Name: @manager.Name, user_id: @manager.user_id } }
